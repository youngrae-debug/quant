...
export default async function HomePage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-14">
      <section className="rounded-2xl border border-zinc-700 bg-black p-8 md:p-10">
        <p className="text-xs uppercase tracking-[0.24em] text-zinc-400">Institutional Equity Research Console</p>
        <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white md:text-5xl">기관 수준의 주식 리서치를 한 화면에서.</h1>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="rounded-lg border border-zinc-600 px-5 py-2.5 text-sm font-medium text-zinc-100 transition hover:bg-zinc-900"
          >
            리서치 방법론
          </Link>
        </div>
