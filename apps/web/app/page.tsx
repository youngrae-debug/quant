    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      <section className="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-10">
        ...
        <p className="mt-4 max-w-3xl text-slate-300 leading-relaxed">
          WATS combines point-in-time fundamentals, technical momentum, and expectation signals into transparent rankings and recommendations.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/top-picks" className="rounded-lg bg-emerald-400 px-6 py-2.5 text-sm font-semibold text-slate-900">Explore Top Picks</Link>
          <Link href="/about-methodology" className="rounded-lg border border-slate-700 px-6 py-2.5 text-sm font-medium text-slate-200">Read Methodology</Link>
        </div>
